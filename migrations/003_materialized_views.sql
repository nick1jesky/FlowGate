...
--
-- Важно: применяется ПОСЛЕ 002_partition_raw_metrics.sql. MV, созданная
-- поверх ещё не партиционированной таблицы, привязывается к её OID и
-- сломает DROP TABLE при последующем партиционировании — поэтому порядок
-- файлов в этой директории имеет значение.
